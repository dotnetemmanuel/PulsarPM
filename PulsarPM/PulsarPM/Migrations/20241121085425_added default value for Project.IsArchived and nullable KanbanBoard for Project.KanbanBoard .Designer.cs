...
namespace PulsarPM.Migrations
{
    ...
    [Migration("20241121085425_added default value for Project.IsArchived and nullable KanbanBoard for Project.KanbanBoard ")]
    partial class addeddefaultvalueforProjectIsArchivedandnullableKanbanBoardforProjectKanbanBoard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PulsarPM.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PulsarPM.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PulsarPM.DAL.Card", b =>
                {
                    b.HasOne("PulsarPM.DAL.KanbanBoard", "KanbanBoard")
                        .WithMany("Cards")
